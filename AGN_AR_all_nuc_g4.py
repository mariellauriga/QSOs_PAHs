...
dl=(409.5,395.0,263.5,460.3)
Lx=(2.5e43, 1.3e44, 7.1e43, 2.9e44)
...
f1 = open('/Users/administrador/Documents/QSOs-part2/QSOs-PAHs/IRS-decomp/spitzer_spectrum/Lbol_all_g4.dat','w+')
for x in Lx:
 kPAH, Lbol_PAH = (Lx2Lbol(x))
 print >>f1, kPAH, Lbol_PAH
f1.close()

k_p, Lbol_p = loadtxt('/Users/administrador/Documents/QSOs-part2/QSOs-PAHs/IRS-decomp/spitzer_spectrum/Lbol_all_g4.dat', unpack=True) 
