...
dl=(151.2, 282.7,282.7,287.4,287.4)
Lx=(4.8e44,3.1e43,3.2e43,5.5e43,2.9e44)
...
f1 = open('/Users/administrador/Documents/QSOs-part2/QSOs-PAHs/IRS-decomp/spitzer_spectrum/Lbol_all_g2.dat','w+')
for x in Lx:
 kPAH, Lbol_PAH = (Lx2Lbol(x))
 print >>f1, kPAH, Lbol_PAH
f1.close()

k_p, Lbol_p = loadtxt('/Users/administrador/Documents/QSOs-part2/QSOs-PAHs/IRS-decomp/spitzer_spectrum/Lbol_all_g2.dat', unpack=True) 
